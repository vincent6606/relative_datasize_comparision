...
parser.add_argument('--depth', default=20, type=int,
                    help='total number of layers [20, 32, 44, 56, 110, 1202] (default: 20)')
parser.add_argument('--features', default=3, type=int,
                    help='number of initial features (default: 3)')
...
def main():
    ...
    for size in datasize:
        ...
        val_loader = torch.utils.data.DataLoader(
            tmp_test,
            batch_size=args.batch_size, shuffle=True, **kwargs)
        depth = {20:3,32:5,44:7,56:9,110:18,1202:200}
        n = depth[args.depth]
        print('num blocks')
	print(n)
        # create model
        model = resnet.ResNet(args.features,[n,n,n]) 
        print(model)
