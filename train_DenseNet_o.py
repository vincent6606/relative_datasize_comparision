...
parser.add_argument('--features', default=12, type=int,
...
parser.add_argument('--name', default='PlainNetwork', type=str,
...
def main():
    ...
    for size in datasize:
        ...
        # create model
        model = dn.DenseNet3(args.depth, 10, args.features, reduction=0.5, dropRate=0)
